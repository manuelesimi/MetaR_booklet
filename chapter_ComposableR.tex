...
Since MetaR 2.0\index{New in MetaR 2.0}, composable R scripts support instant refresh. Changing the script will trigger re-runs of the script in the background and will update plots and tables in real time. See Chapter~\ref{chapter:instantRefresh} for details. 
\section{installOrLoad statement}\index{installOrLoad}
