...
Finally, we invoke the "Use Column Groups From Table: <table name>" intention as shown in Figure ~\ref{fig:AnnotateTableIntention} to apply the group names from the table to our destination Table. 
\begin{figure}[h!tbp]
  \centering
