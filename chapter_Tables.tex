...
\caption[Covariate Table]{\textbf{Sample Covariate Table} }
\label{fig:CovariateTable}
\end{figure}

A covariate table can be associated to a column group by pressing \keys{\lbrack} at the end of the group in the editor or by using the intention shown in Figure~\ref{fig:AddCovariateTable}. 
\begin{figure}
\centering
  \includegraphics[width=\figWidthNarrow]{figures/IntentionForAddingCovariateTable.png}
