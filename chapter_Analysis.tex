...
\subsection{build heatmap}\index{heatmap}
Use this statement (\texttt{build heatmap}) to construct a heatmap. Figure~\ref{fig:NewBuildHeatmap} presents a new \texttt{build heatmap} statement.
