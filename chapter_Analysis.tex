...
As first strategy, we join A and B by the column Gene. The results table generated by Join is shown in Figure~\ref{fig:ResultsTableJoinByColumnStatement}. If we analyze the structure of the table, we note that:
\begin{itemize}
