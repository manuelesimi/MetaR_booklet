...
{\raisebox{4cm}{\includegraphics[scale=\coverScalingFactor]{Pictures/MetaRBookCover-v2.pdf}}}} % Image background
\mbox{}
\endgroup
} {
...
\noindent Copyright \copyright\ 2015-2018 Fabien Campagne.\\ % Copyright notice

\noindent \textsc{Published by Clinical and Translational Science Center}\\ % Publisher
\noindent \textsc{Weill Cornell Medicine, New York, NY}\\ % Publisher
...
\noindent \textit{Version 2.4.5 Nov 2018}
...
\input{chapter_Tables}
\input{chapter_Analysis}
\input{chapter_Docker}
\input{chapter_SCnorm} 
\input{chapter_InstantRefresh}
\input{chapter_EdgeR} 
\input{chapter_Limma}
\input{chapter_Sleuth}
\input{chapter_Biomart}
\input{chapter_Functions}
\input{chapter_Seurat}
\input{chapter_SimulateDatasets}
\input{chapter_ExtendingMetaR}
\input{chapter_ComposableR}
}{
