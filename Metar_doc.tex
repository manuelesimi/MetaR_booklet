...
\ifthenelse {\boolean{tablet}}{
\newcommand{\coverScalingFactor}[0]{0.45}
...
{\includegraphics[scale=\coverScalingFactor]{Pictures/MetaRBookCover-v1.pdf}}} % Image background
\mbox{}
\endgroup
} {
...
{First Edition.} Version 1.1.1, Feb 2015} % Printing/edition date 
